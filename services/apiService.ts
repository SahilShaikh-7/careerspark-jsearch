...
// This check ensures the key is present before making any calls.
...
// IMPORTANT: Replace with your actual JSearch API key from RapidAPI or set environment variable JSEARCH_API_KEY
const JSEARCH_API_KEY = process.env.JSEARCH_API_KEY || "abdab7afefmsh7a689eed899d741p153425jsne4e416b97f36";

// Updated check to ensure the key is set and not the placeholder
export const isJsearchConfigured = JSEARCH_API_KEY !== JSEARCH_PLACEHOLDER && JSEARCH_API_KEY.trim() !== "";

// Analysis schema for resume parsing
